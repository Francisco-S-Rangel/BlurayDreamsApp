...
@Component({
  selector: 'app-perfil-usuario-cadastrar-cobranca',
  templateUrl: './perfil-usuario-cadastrar-cobranca.component.html',
  styleUrls: ['./perfil-usuario-cadastrar-cobranca.component.css']
})
export class PerfilUsuarioCadastrarCobrancaComponent implements OnInit {
