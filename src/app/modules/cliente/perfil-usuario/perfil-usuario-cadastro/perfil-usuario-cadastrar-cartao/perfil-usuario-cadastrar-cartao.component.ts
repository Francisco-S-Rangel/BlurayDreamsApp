...
@Component({
  selector: 'app-perfil-usuario-cadastrar-cartao',
  templateUrl: './perfil-usuario-cadastrar-cartao.component.html',
  styleUrls: ['./perfil-usuario-cadastrar-cartao.component.css']
})
export class PerfilUsuarioCadastrarCartaoComponent implements OnInit {
  ...
  backPage() {
    this.router.navigate(['/perfil-usuario-cartoes']);
  }
