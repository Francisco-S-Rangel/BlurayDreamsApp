...
const routes: Routes = [
  ...
  {path: "perfil-usuario-trocas/:idpedido", component: PerfilUsuarioTrocasComponent},
  ...
  {path: "motivo-ativacao-funcionario/:id", component: MotivoAtivacaoFuncionarioComponent},
